...
declare module "hardhat/types/runtime" {
  interface HardhatEthersHelpers extends HardhatEthersHelpersBase {
    ...
    getContractFactory(
      name: "AYLRandomWinner",
      signerOrOptions?: ethers.Signer | FactoryOptions
    ): Promise<Contracts.AYLRandomWinner__factory>;
    getContractFactory(
      name: "AYLToken",
      signerOrOptions?: ethers.Signer | FactoryOptions
    ): Promise<Contracts.AYLToken__factory>;
    getContractFactory(
      name: "AYLWhiteList",
      signerOrOptions?: ethers.Signer | FactoryOptions
    ): Promise<Contracts.AYLWhiteList__factory>;
    ...
    getContractAt(
      ...
      address: string,
      signer?: ethers.Signer
    ): Promise<Contracts.AYLRandomWinner>;
    getContractAt(
      name: "AYLToken",
      address: string,
      signer?: ethers.Signer
    ): Promise<Contracts.AYLToken>;
    getContractAt(
      name: "AYLWhiteList",
      address: string,
      signer?: ethers.Signer
    ): Promise<Contracts.AYLWhiteList>;
